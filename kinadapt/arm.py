...
class two_link:
    ...
    def __init__(self, dt=1e-4):
        ...
        self.max_angles = [np.pi - .1, np.pi - .05]
        self.min_angles = [-.1, -np.pi + .05]
    ...
    def apply_torque(self, u, dt=None):
        ...
        # if self.q0 < self.min_angles[0]:
        #     self.q0 = self.min_angles[0]
        #     self.dq0 = 0.0
        # if self.q0 > self.max_angles[0]:
        #     self.q0 = self.max_angles[0]
        #     self.dq0 = 0.0
        #
        # if self.q1 < self.min_angles[1]:
        #     self.q1 = self.min_angles[1]
        #     self.dq1 = 0.0
        # if self.q1 > self.max_angles[1]:
        #     self.q1 = self.max_angles[1]
        #     self.dq1 = 0.0
